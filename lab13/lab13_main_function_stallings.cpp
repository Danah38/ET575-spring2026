...
// example 1: void function. void fuctions are functions that don't return any value
void printHello(){
...
void printare(int length, int width, int area){
